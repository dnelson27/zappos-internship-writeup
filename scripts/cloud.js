...
//Messages
const monitor_message = "Traffic Monitoring: This is a collection of in-line appliances and software that monitors all incoming and outgoing network traffic. These include IPS, IDS, and NGFW appliances. These solutions can dynamically respond to suspicious activity, send alerts, and block malicious traffic."
...
const rds_message = "Amazon RDS: This node represents the database resources for this company. Multiple RDS instances can be used for different roles, like storing information for company applications and network resources. Implementing Amazon RDS allows this company to run a secure and scalable database infrastructure without requiring the company to purchase the hardware and space needed to run a high-availability database cluster. Using RDS allows security engineers to focus more on securing access to sensitive information, and less on securing the hardware, operating system, and other server components."
